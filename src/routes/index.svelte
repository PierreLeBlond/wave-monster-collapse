...
<svelte:head>
  <title>wave monster collapse</title>
  <meta name="description" content="Wave function collapse example" />
</svelte:head>

<main class="w-full h-full flex">
  {#if display}
    <Control bind:mapSize={mapSize} bind:tilesetInfos={tilesetInfos} bind:selectedPattern={selectedPattern}/>
